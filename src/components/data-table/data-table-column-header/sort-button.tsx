    ...
    <TooltipProvider delayDuration={100}>
      <Tooltip>
        <TooltipTrigger {...otherProps} asChild>
          <Icon
            className={cn(
              'cursor-pointer rounded-md border border-transparent text-muted-foreground/70 hover:border-muted-foreground/10 hover:bg-muted hover:text-muted-foreground',
              !!direction && 'text-primary hover:text-primary/80'
            )}
            size={direction ? 24 : 20}
          />
        </TooltipTrigger>
